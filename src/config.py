...
SGTM_FEATURE__STALENESS_CHECK_ENABLED = is_feature_flag_enabled(
    "SGTM_FEATURE__STALENESS_CHECK_ENABLED"
)
SGTM_FEATURE__STALENESS_CHECK_DURATION = int(os.getenv("SGTM_FEATURE__STALENESS_CHECK_DURATION", "0"))