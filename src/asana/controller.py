...
def add_comment_to_task(comment: Comment, task_id: str):
    ...
    asana_comment_id = dynamodb_client.get_asana_id_from_github_node_id(github_comment_id)
    if asana_comment_id is None:
        ...
        dynamodb_client.insert_github_node_to_asana_id_mapping(github_comment_id, asana_comment_id)
    else:
...
def add_review_to_task(review: Review, task_id: str):
    ...
    asana_comment_id = dynamodb_client.get_asana_id_from_github_node_id(github_review_id)
    if asana_comment_id is None:
        ...
        dynamodb_client.insert_github_node_to_asana_id_mapping(github_review_id, asana_comment_id)
    else:
