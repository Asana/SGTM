...
class TestAsanaCommentFromGitHubReview(MockDynamoDbTestCase):
    ...
    def test_includes_review_text(self):
        ...
        asana_review_comment = src.asana.helpers.asana_comment_from_github_review(github_review)
        self.assertContainsStrings(asana_review_comment, ["GITHUB_REVIEW_TEXT", "GITHUB_REVIEW_COMMENT_TEXT"])
    ...
    def test_includes_asana_review_comment_author(self):
        ...
        asana_review_comment = src.asana.helpers.asana_comment_from_github_review(github_review)
        self.assertContainsStrings(asana_review_comment, ["TEST_USER_ASANA_DOMAIN_USER_ID"])
    ...
    def test_handles_non_asana_review_comment_author_gracefully(self):
        ...
        asana_review_comment = src.asana.helpers.asana_comment_from_github_review(github_review)
        self.assertContainsStrings(asana_review_comment, ["github_unknown_user_login", "GITHUB_UNKNOWN_USER_NAME"])
    ...
    def test_handles_non_asana_review_comment_author_that_has_no_name_gracefully(self):
        ...
        asana_review_comment_comment = src.asana.helpers.asana_comment_from_github_review(github_review)
        self.assertContainsStrings(asana_review_comment_comment, ["github_unknown_user_login"])
    ...
    def test_does_not_inject_unsafe_html(self):
        ...
        for unsafe_character in unsafe_characters:
            ...
            self.assertNotEqual(asana_review_comment_comment, unexpected, f"Expected the {unsafe_character} character to be escaped")
    ...
    def test_considers_double_quotes_safe_in_review_text(self):
        ...
        for safe_character in safe_characters:
            ...
            self.assertEqual(asana_review_comment, expected, f"Did not expected the {safe_character} character to be escaped")
