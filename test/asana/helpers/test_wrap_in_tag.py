...
class TestWrapInTag(BaseClass):
    ...
    def test_basic_usage(self):
        ...
        self.assertEqual(actual, "<movie>A long time ago in a galaxy far, far away...</movie>")
    ...
    def test_multiple_attributes(self):
        actual = _wrap_in_tag("p", {"by": "leia", "with": "snark"})("Why you stuck-up, half-witted, scruffy-looking nerf herder.")
        self.assertEqual(actual, '<p by="leia" with="snark">Why you stuck-up, half-witted, scruffy-looking nerf herder.</p>')
    ...
    def test_text_contains_emoji(self):
        actual = _wrap_in_tag("li")("...the ship that made the Kessel Run in less than twelve parsecs...🚀")
        self.assertEqual(actual, '<li>...the ship that made the Kessel Run in less than twelve parsecs...🚀</li>')
