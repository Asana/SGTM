...
class TestHandlePullRequestReviewComment(BaseClass):
    ...
    def test_comment_edit(self, get_pull_request_and_comment, upsert_review, review_from_comment, delete_comment, lock):
        payload = {
            "pull_request": {
                "node_id": "abcde"
            },
    ...
    def test_comment_deletion_when_review_still_present(self, get_review_for_database_id, get_pull_request, upsert_review, delete_comment, lock):
        payload = {
            "pull_request": {
                "node_id": "abcde"
            },
    ...
    @patch('src.github.controller.delete_comment')
    @patch('src.github.controller.upsert_review')
    @patch('src.github.graphql.client.get_pull_request', return_value=MagicMock(spec=PullRequest))
